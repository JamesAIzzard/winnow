...
class TestCategoricalEstimatorEstimate:
    def test_returns_mode(self) -> None:
        ...
        result = estimator.compute_estimate(samples=["a", "b", "a", "c", "a"])

        assert result == "a"

    def test_handles_tie_by_first_encountered(self) -> None:
        ...
        result = estimator.compute_estimate(samples=["a", "b", "a", "b"])

        assert result in {"a", "b"}


class TestCategoricalEstimatorConfidence:
    def test_full_confidence_for_unanimous(self) -> None:
    ...
    def test_zero_confidence_for_empty_samples(self) -> None:
        ...
        confidence = estimator.compute_confidence(samples=[], estimate="a")

        assert confidence == 0.0

    def test_normalised_against_baseline(self) -> None:
